...
1. [다음 링크](https://github.com/kyujin-cho/pixel-volte-patch/releases/download/1.1.1/dev.bluehouse.enablevolte.apk) 혹은 이 Github Repository의 Releases 탭으로 이동하여 최신 패치 어플리케이션의 설치를 위한 APK 파일을 Pixel 단말기에 다운로드 받습니다.
